...
class SABi:
	...
	def __auth(self):
		...
		É necessário efetuar um acesso a página para puxar uma variável de sessão.
		A variável de sessão é usada na montagem dos links, em um formato +- assim:
